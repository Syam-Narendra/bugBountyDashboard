        ...
        <AlertDialogDescription>
          <div className="p-6 text-white rounded-lg shadow-lg mx-auto">
            ...
            <p className="mb-4">
              ...
              discovered. The more details you provide, the quicker iTalent team
              will be able to validate and resolve the issue.
            </p>
            ...
            <ul className="list-disc ml-6 mb-4">
              ...
              <li>
                Duplicates will only award the first fully reproducible report.
              </li>
              <li>
